...
template: circle-basic | runId: ndjc-1761367185219

| Anchor | InTemplate | InSanitized | File |
|---|---|---|---|
| NDJC:PACKAGE_NAME | HIT | NO | app/build.gradle |
...
| NDJC:ENABLE_POSTING | MISS | NO |  |
| NDJC:ENABLE_COMMENTS | MISS | NO |  |
| NDJC:ENABLE_LIKES | MISS | NO |  |
| NDJC:PROFILE_EDIT_ENABLED | MISS | NO |  |
| NDJC:NOTIFICATIONS_ENABLED | MISS | NO |  |
...
| BLOCK:POST_COMPOSER | MISS | NO |  |
| BLOCK:POST_CARD | MISS | NO |  |
| BLOCK:FEED_LIST | MISS | NO |  |
| BLOCK:POST_DETAIL | MISS | NO |  |
| BLOCK:COMMENTS_SCREEN | MISS | NO |  |
| BLOCK:COMMENT_ITEM | MISS | NO |  |
| BLOCK:LIKE_BUTTON | MISS | NO |  |
| BLOCK:NOTIFICATIONS_SCREEN | MISS | NO |  |
| BLOCK:EDIT_PROFILE_SCREEN | MISS | NO |  |
| BLOCK:SEARCH_SCREEN | MISS | NO |  |
| BLOCK:MEDIA_PICKER | MISS | NO |  |
...
| LIST:COMMENT_FIELDS | HIT | NO | app/src/main/java/com/ndjc/app/ui/screens/HomeScreen.kt |
| LIST:FEED_QUERY_PARAMS | MISS | NO |  |
| LIST:PROFILE_FIELDS | MISS | NO |  |
| LIST:NOTIFICATION_TYPES | MISS | NO |  |
| LIST:UPLOAD_MIME_TYPES | MISS | NO |  |
...
| IF:ENABLE_POSTING | MISS | NO |  |
| IF:ENABLE_COMMENTS | MISS | NO |  |
| IF:ENABLE_LIKES | MISS | NO |  |
| IF:REQUIRE_LOGIN | MISS | NO |  |
| IF:SHOW_NOTIFICATIONS | MISS | NO |  |
...
| HOOK:POST_SUBMIT | MISS | NO |  |
| HOOK:FETCH_FEED | MISS | NO |  |
| HOOK:FETCH_POST | MISS | NO |  |
| HOOK:FETCH_COMMENTS | MISS | NO |  |
| HOOK:COMMENT_SUBMIT | MISS | NO |  |
| HOOK:LIKE_TOGGLE | MISS | NO |  |
| HOOK:UPLOAD_MEDIA | MISS | NO |  |
| HOOK:FETCH_NOTIFICATIONS | MISS | NO |  |
