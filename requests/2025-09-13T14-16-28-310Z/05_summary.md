# NDJC Run 2025-09-13T14-16-28-310Z

- mode: **A**
- allowCompanions: **false**
- template: **core**
- appName: **兰博基尼历史车型**
- packageId: **com.lamborghini.history**
- repo: `/var/task`
...
- `NDJC:PACKAGE_NAME` @ `/tmp/ndjc/app/build.gradle` → replaced=0, found=false
- `NDJC:COMPILE_SDK` @ `/tmp/ndjc/app/build.gradle` → replaced=0, found=false
- `NDJC:MIN_SDK` @ `/tmp/ndjc/app/build.gradle` → replaced=0, found=false
- `NDJC:TARGET_SDK` @ `/tmp/ndjc/app/build.gradle` → replaced=0, found=false
- `NDJC:VERSION_CODE` @ `/tmp/ndjc/app/build.gradle` → replaced=0, found=false
- `NDJC:VERSION_NAME` @ `/tmp/ndjc/app/build.gradle` → replaced=0, found=false
