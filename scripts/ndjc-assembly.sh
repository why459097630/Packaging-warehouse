...
const launcherVerifyTargets = [
  ...
  "templates/Core-Templates/app/src/main/res/mipmap-mdpi/ic_launcher_foreground.png",
  "templates/Core-Templates/app/src/main/res/mipmap-hdpi/ic_launcher_foreground.png",
